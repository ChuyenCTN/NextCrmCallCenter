...
import com.hosco.nextcrm.callcenter.databinding.CallIncomingActivityBinding
...
class IncomingCallActivity : GenericActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AllContactList.getInstance().temporaryPhone = incomingCall?.remoteAddress?.username
